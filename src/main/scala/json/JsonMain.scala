...
object JsonMain extends App {
  ...
  val originalMessage =
    "{\"fragmentType\":\"SERIES\", \"uuid\":\"1234\", \"localizableInformation\":[ {\"language\": \"eng\", \"title\": \"Game of Thrones\"} ]}"
  val updatedMessage =
    "{\"fragmentType\":\"SERIES\", \"uuid\":\"1234\", \"localizableInformation\":[ {\"language\": \"esp\", \"title\": \"Game of Thrones\"} ]}"
